...
for n in enteros:
    l=np.math.factorial(a-1)
    v_real.append(l)
ERP=[]
for k in range(0,9,1):
    erp=abs(v_real[k]-Tt[k])*100/v_real[k]
    ERP.append(erp)
    print("El erp para a =",enteros[k],"es de un",erp,"%")
pl.subplot(1,2,1)
...
for n in y:
    NN.append(f(n))
    print("En el año",n,"había un poblacion estimada de",f(n),"personas")
